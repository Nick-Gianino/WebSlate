...
const LoggedInHomePage = () => {
    ...
    const boxes = [
        ...
        { content: 'Submit', text: 'Get in touch with us', subheader: 'Get in touch with us to receive a quote or ask any questions about our services', imageSrc: '/card_3.png' },
    ];
            ...
            {boxes.map((box, index) => (
                <div className="box" key={index}>
                    <img
                        ...
                        className="boximg"
                        style={index === 2 ? { width: '225px', height: '320px', } : index === 1 ? {paddingTop: '18px' } : {}}
                    />
